...
class UpdateFirearmEmergencyModel extends StatefulWidget {
  UpdateFirearmEmergencyModel({
    super.key,
    required this.name,
    required this.brand,
    required this.model,
  ...
  @override
  State<UpdateFirearmEmergencyModel> createState() =>
      _UpdateFirearmEmergencyModelState();
}

class _UpdateFirearmEmergencyModelState
    extends State<UpdateFirearmEmergencyModel> {
  ...
  void _handleUpdateEmergency() async {
    if (_authorized == 'Authorized') {
      ...
      var res = await firearmDetailsController.addFirearm(
        widget.name,
        widget.brand,
        widget.model,
        widget.serialNumber,
      ...
      updateEmergency(res['userId'], res['id'],widget.isChecked);
